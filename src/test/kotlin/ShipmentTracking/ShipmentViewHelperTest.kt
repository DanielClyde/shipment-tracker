...
internal class ShipmentViewHelperTest {
    ...
    fun overnightShipmentValidity() {
        ...
        val threeDaysFromNow = LocalDateTime.now().plusDays(3).toEpochSecond(ZoneOffset.MIN)
        shipment.setStatus("shipped", LocalDateTime.now().toEpochSecond(ZoneOffset.MIN))
        shipment.setExpectedDeliveryTimestamp(threeDaysFromNow)
    ...
    fun expressShipmentValidity() {
        ...
        assertNull(shipment.error)
        val fiveDaysFromNow = LocalDateTime.now().plusDays(5).toEpochSecond(ZoneOffset.MIN)
        shipment.setStatus("shipped", LocalDateTime.now().toEpochSecond(ZoneOffset.MIN))
        shipment.setExpectedDeliveryTimestamp(fiveDaysFromNow)
